# E10b follow-up (Prompt E 2026-07-17): Scenario I calibration inference
...
# Production protocol replicated (scenario1.r): reps ascending from a cold
...
write.csv(new_cal, file.path(OUTPUT_DIR, "e10b_s1_cal_new.csv"), row.names = FALSE)

old_cal <- read.csv(file.path(OUTPUT_DIR, "scenario1_calibration.csv"))
...
cat("TOTAL S1 STAR FLIPS:", tot_flips, "\n")
cat("E10B_S1_STARS_DONE\n")
