...
QAIDR provides tools for evaluating how well interval-based
dimensionality reduction (DR) methods preserve the structure of
high-dimensional interval data, using a co-ranking matrix framework.
